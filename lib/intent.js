...
async function applyIntent(tradecard = {}, { infer = false, resolve = 'hybrid' } = {}) {
  ...
  const coverage = { attempted: keys.length, sent: sent_keys.length };
  const trace = [
    { stage: 'intent_coverage', coverage, sample_sent: sent_keys.slice(0, 10) },
  ];
