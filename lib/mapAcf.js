...
function mapTradecardToAcf(tc = {}) {
  ...
  addField(fields, 'identity_owner', tc.business?.owner, dropped_empty);
  addField(fields, 'identity_role_title', tc.business?.role_title, dropped_empty);
  addField(fields, 'identity_headshot_url', tc.business?.headshot, dropped_empty);
  addField(fields, 'identity_address', tc.business?.address, dropped_empty);
  addField(fields, 'identity_abn', tc.business?.abn, dropped_empty);
